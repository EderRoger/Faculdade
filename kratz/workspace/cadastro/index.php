...
if($_GET['tipo'] == "alterar"){ 
	$action = "alterar.php";
	//guardando o conteudo nao clicado...
	$arquivo = new ARQUIVO();
	$arquivo->setArquivo("cliente.txt");
	$arquivo->setOperacao("r");
		
	$conteudoNaoAlterado = $arquivo->buscarConteudoQueNaoSeraAlterado($_GET['nome']);
...
<html> 
  ...
  <body> 
	...
	<form method="post" action="<?=$action; ?>">
	    <input type="hidden" value="<?=$conteudoNaoAlterado; ?>" name="conteudoNaoAlterado" />
