...
echo '<!doctype html>'; 
	...
	$conteudoNaoAlterado = $_POST['conteudoNaoAlterado'];
	
	echo "O Cliente ".$cliente->getNomeCliente()." será alterado em arquivo.";
	...
	$arquivo->setOperacao("r+");
	 ...
	 $conteudoCliente = $cliente->getNomeCliente().";".
					   ...
					   $conteudoCliente.=$conteudoNaoAlterado;				   
					   
	echo "<p>".$arquivo->alterar($conteudoCliente)."</p>";
